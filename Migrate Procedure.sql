...
BEGIN
    ...
    SELECT INVOICE_REFERENCE, INVOICE_DATE, o.Id, INVOICE_STATUS, INVOICE_HOLD_REASON, INVOICE_AMOUNT, INVOICE_DESCRIPTION
    FROM XXBCM_ORDER_MGT o
    INNER JOIN `Order` ord ON o.ORDER_REF = o.ORDER_REF;
END //
